      ...
      >
        ...
        <Box mt={3} mb={3}>
          <TextField
            ...
            {...register("idIniciativaInvestigacion")}
            defaultValue={pid?.idIniciativaInvestigacion}
          />
            ...
            <FormControl fullWidth error={Boolean(errors.tipoPid)}>
              ...
              >
                <MenuItem value="" disabled>
                  Seleccione un tipo PID
                </MenuItem>
                {tipoPids.map((tipoPid) => (
                  <MenuItem key={tipoPid.idTipoPid} value={tipoPid.idTipoPid}>
                    {tipoPid.descripcion}
                  </MenuItem>
                ))}
              </Select>
          ...
          <Box mt={3} mb={3}>
            <FormControl fullWidth error={Boolean(errors.uct)}>
              ...
              >
                ...
                {ucts.map((uct) => (
                  <MenuItem key={uct.idUct} value={uct.idUct}>
                    {uct.denominacion}
                  </MenuItem>
                ))}
              </Select>
